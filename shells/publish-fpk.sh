...
sed -i "s|{version}|1.1.4|g" public/publish-fpk/docker/manifest
sed -i "s|{changelog}|1. index.cgi|g" public/publish-fpk/docker/manifest
sed -i "s|{version}|v1.1.4|g" public/publish-fpk/docker/app/docker/docker-compose.yaml
